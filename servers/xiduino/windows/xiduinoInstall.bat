...
IF DEFINED PUBLIC (SET UDESKTOP=%userprofile%\Desktop) & (SET USTARTMENU=%AppData%\Microsoft\Windows\Start Menu\Programs) & (SET UDOCS=%userprofile%\Documents)ELSE (SET UDESKTOP=%userprofile%\Desktop) & (SET USTARTMENU=%userprofile%\Start Menu\Programs) & (SET UDOCS=%userprofile%\Documents)
echo.

pause

echo 1. creation d'un dossier Xi dans le dossier personnel de l'utilisateur
